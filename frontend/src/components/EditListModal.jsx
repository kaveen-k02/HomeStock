...
//         <h2 className="text-xl font-semibold mb-4">Edit Shopping List</h2>
//         <input
//           type="text"
//           value={editListTitle}
...
const EditListModal = ({ editListTitle, setEditListTitle, handleUpdateList, setIsEditListModalOpen, error, loading }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
        <h2 className="text-xl font-semibold text-teal-800 mb-6">Edit Shopping List</h2>
        <div className="mb-6">
